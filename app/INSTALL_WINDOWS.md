...
This script validates toolchain, checks for duplicate function declarations in `src\ui\App.jsx`, runs build/tests, builds PE installers, and verifies release artifacts. It also auto-detects the correct app directory when invoked from nested folders.
